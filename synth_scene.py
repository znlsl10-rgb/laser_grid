...
#   unisj_proto 화각 43.34°(등탄젠트) · 굴림 38° → 자 걸침 반폭 D ≈ 300mm
#
# [2026-09-21] 시제품 프로파일 값은 같은 방법으로 구했다 — 잡음 0 에서 V선을
# 늘려 가며 수렴을 확인했다: 150선 2.682 → 250선 3.248 → 400선 3.255mm.
# 250선과 400선의 차이가 0.007mm 라 수렴으로 본다. 해석식 gap(d) 에 A=6mm,
# σ=50mm, D=300mm 을 넣으면 3.28mm 로 같은 자리다.
# 150선이 낮게 나오는 것은 알고리즘 편향이 아니라 분해능이다 — 12mm 렌즈의
# 좁은 화각에 굴림 38° 라 면내 점밀도가 낮고, 자 처짐은 그때 하한값이 된다.
GT_STRAIGHTEDGE_MM = {"legacy": 2.60, "pdf": 4.54, "improved": 4.01,
                      "diagonal": 4.07, "unisj_proto": 3.25}
